                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                if ($get->status_pengobatan == 4) {
                                                    echo "<span class='badge badge-danger' style='color: white;'>Ditolak</span>";
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('Admin/detail_pengobatan/' . $get->kd_payment) ?>" title="detail pengobatan" class="badge bg-primary" style="color: white;"><i class="fa fa-list"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
