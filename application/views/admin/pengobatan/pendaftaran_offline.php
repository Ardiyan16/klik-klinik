...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left">
            ...
            <a href="<?= base_url('Admin/pendaftaran') ?>" style="margin-left: 15px; margin-top: 20px;" class="btn btn-success"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
        </div>
    </div>
    <div class="col-md-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>From Pendaftaran Offline</h2>
            ...
            <div class="x_content">
                ...
                <a href="<?= base_url('Admin/create_users') ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah Pasien</a>
                <br />
                <br>
