        ...
        <div class="top_tiles">
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats">
                    ...
                    <div class="count"><?= $jml_user_online ?></div>
                    <h3>User Online</h3>
                    <p>Jumlah User Online Aktif</p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats">
                    <div class="icon"><i class="fa fa-users"></i></div>
                    <div class="count"><?= $jml_user_offline ?></div>
                    <h3>User Offline</h3>
                    <p>Jumlah User Offline Aktif</p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats">
