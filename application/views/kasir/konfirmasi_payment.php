...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <br>
            <form action="<?= base_url('Kasir/save_payment') ?>" method="POST">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="hidden" name="id_pengobatan" value="<?= $view->id ?>">
                            <input type="hidden" name="kd_pendaftaran" value="<?= $view->kd_pendaftaran ?>">
                            <input type="hidden" value="<?= $view->kd_trans ?>" name="id_trans" id="no_trans" readonly class="form-control no_trans">
                            <input type="text" name="nama_pasien" value="<?= $view->name ?>" readonly id="nama_pasien" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="dokter" value="<?= $view->nama ?>" readonly class="form-control dokter">
                        </div>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><span class="fas fa-stethoscope"></span> </span>
                            </div>
                            <input type="text" value="<?= $view->diagnosa ?>" name="diagnosa" id="no_trans" readonly class="form-control ">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <?php
                ...
                <div class="row" id="formPayment">
                    <div class="col-md-3">
                        <label for="">Biaya Pengobatan</label>
                        <div class="input-group mb-3">
                            <input autocomplete='off' required type='text' readonly class='form-control tarif' value="<?= $view->tarif ?>" name='tarif' id='tarif_pengobatan'>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="total_biaya_pengobatan" id="total_biaya_pengobatan" readonly class="form-control total_biaya_pengobatan">
                        </div>
                    </div>
                    <div class="col-md-3">
...
<script>
    ...
    // $(document).on('each', '#tarif_pengobatan', function() {

    //     var Tarif = $('#tarif_pengobatan').val();
    //     var TransObat = $('#biaya_trans_obat').val();

    //     var TotalBiayaPengobatan = parseInt(Tarif) + parseInt(TransObat);
    //     if (TotalBiayaPengobatan > 0) {
    //         var HasilBiayaPengobatan = TotalBiayaPengobatan;
    //         TotalBiayaPengobatan = to_rupiah(TotalBiayaPengobatan);
    //     } else {
    //         TotalBiayaPengobatan = '';
    //         var HasilBiayaPengobatan = 0;
    //     }

    //     var TotalBiayaPengobatan2 = parseInt(Tarif) + parseInt(TransObat);
    //     if (TotalBiayaPengobatan2 > 0) {
    //         var HasilBiayaPengobatan2 = TotalBiayaPengobatan2;
    //         TotalBiayaPengobatan2 = to_rupiah(TotalBiayaPengobatan2);
    //     } else {
    //         TotalBiayaPengobatan2 = '';
    //         var HasilBiayaPengobatan2 = 0;
    //     }
    //     $('#total_biaya_pengobatan').val(HasilBiayaPengobatan);
    ...
    // $(document).on('each', '#biaya_trans_obat', function() {
    //     var Tarif = $('#tarif_pengobatan').val();
    //     var TransObat = $('#biaya_trans_obat').val();
    ...
    //     }
    //     $('#total_biaya_pengobatan').val(HasilBiayaPengobatan);
    //     console.log(HasilBiayaPengobatan);
    //     HitungTotalBayar();
    // })

    $(document).ready(function() {
        $('#tarif_pengobatan, #biaya_trans_obat').each(function() {
            var Tarif = $('#tarif_pengobatan').val();
            var TransObat = $('#biaya_trans_obat').val();
        ...
        $('#total_biaya_pengobatan, #jml_dibayarkan').keyup(function() {
            var TotalBiaya = $('#total_biaya_pengobatan').val();
