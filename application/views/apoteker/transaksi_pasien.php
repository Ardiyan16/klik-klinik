                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="hidden" name="id_resep" value="<?= $view->id ?>">
                            <input type="hidden" name="id_pengobatan" value="<?= $view->id_pengobatan ?>">
                            <input type="text" name="nama_pasien" value="<?= $view->name ?>" readonly id="nama_pasien" class="form-control nama_pasien">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control mb-3 resep" name="resep" readonly rows="3"><?= $view->resep ?></textarea>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="kd_trans" id="no_trans" readonly class="form-control no_trans">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <?php
