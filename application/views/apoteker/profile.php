                    ...
                    <div class="x_content">
                        <div class="col-md-8 col-sm-3  profile_left">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <img class="img-responsive avatar-view" src="<?= base_url('assets/img/image_team/' . $profile->picture) ?>" height="250" width="300" alt="Avatar" title="Foto Anda">
                                </div>
                            </div>
                            <h3><?= $profile->nama ?></h3>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?= base_url('Apoteker/update_profile') ?>">
